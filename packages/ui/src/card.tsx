...
const SUIT_PATH: Record<Suit, string> = {
  ...
  c: 'M12 2 C13.93 2 15.5 3.57 15.5 5.5 C15.5 7.43 13.93 9 12 9 C10.07 9 8.5 7.43 8.5 5.5 C8.5 3.57 10.07 2 12 2 Z M6 9 C8.21 9 10 10.79 10 13 C10 15.21 8.21 17 6 17 C3.79 17 2 15.21 2 13 C2 10.79 3.79 9 6 9 Z M18 9 C20.21 9 22 10.79 22 13 C22 15.21 20.21 17 18 17 C15.79 17 14 15.21 14 13 C14 10.79 15.79 9 18 9 Z M10 16 L14 16 L15 23 L9 23 Z',
};
