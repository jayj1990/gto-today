...
export default function NotFound() {
  return (
    <main className="relative mx-auto flex min-h-dvh max-w-xl flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="font-display mt-3 text-[38px] font-bold leading-[1.1] tracking-[-0.02em]">
        없는 스팟이에요.
      </h1>
      ...
      <div className="mt-8 grid w-full max-w-xs grid-cols-2 gap-2">
        ...
        <Link
          href="/today"
          className="border-hair surface inline-flex h-12 items-center justify-center rounded-[var(--radius-button)] text-[14px] font-semibold active:scale-[0.98]"
        >
          오늘의 훈련 →
        </Link>
      </div>

      <nav className="text-fg-muted mt-10 flex flex-wrap justify-center gap-x-5 gap-y-1 text-[11px]">
