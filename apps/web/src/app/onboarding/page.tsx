...
const SLIDES: Slide[] = [
  {
    eyebrow: '매일의 훈련',
    title: '하루 10핸드,\n더 나은 판단.',
    body: '오늘 플레이어 모두가 같은 10핸드를 풀어요. 꾸준한 훈련으로 실력을 쌓아보세요.',
    visual: 'cards',
  },
  {
    eyebrow: 'GTO 기반',
    title: '이론이 아닌\n습관으로.',
    body: '포지션·스택·시나리오별 GTO 믹스를 즉시 확인하고, AI가 그 이유까지 풀어드려요.',
    visual: 'chips',
  },
  {
    eyebrow: '모바일 우선',
    title: '내 상황에\n맞춰서.',
    body: '내 포지션과 핸드만 입력하면 GTO 답이 바로 나와요. 실전 중에도 가볍게 꺼내 쓰세요.',
    visual: 'mark',
  },
];
