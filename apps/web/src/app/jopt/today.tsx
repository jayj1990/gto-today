...
const STOPS: Stop[] = [
  {
    ...
    tag: 'move',
    title: '숙소 출발 (도보 3분)',
    meta: '北7条東4 → 北8条東5 토리톤 · 240m',
    desc: [
      '여권을 꼭 챙기세요. 면세 카운터도, 위스키 정가 판매점의 1인 1병 확인도 전부 여권으로 합니다. 낮 20도에 흐림이고 밤에 약한 비가 올 수 있어서 얇은 겉옷 하나면 됩니다. 토리톤은 대기가 길기로 유명해서 1시 전에 줄에 서는 게 좋습니다.',
    ],
    map: '回転寿しトリトン 北8条光星店',
    mapLabel: '토리톤까지 경로',
  },
  {
    ...
    tag: 'food',
    title: '토리톤 스시 · 北8条光星店',
    img: '/jopt/today/toriton.jpg',
    alt: '토리톤 스시 카운터',
    credit: 'Ben C',
    meta: '北8条東5-19-1 · 11:00-22:00 · 회전초밥 · 구글 4.2 (4,902) · 011-374-8666',
    desc: [
      '숙소에서 걸어서 3분, 삿포로에서 제일 유명한 회전초밥입니다. 점심시간엔 30분에서 1시간 대기가 보통이라 입구 발권기에서 번호를 먼저 뽑고 기다리세요. 8명은 두 테이블로 나뉠 수 있습니다.',
      '홋카이도 생선이 강점이라 연어, 가리비, 게, 성게 순으로 시키면 됩니다. 1인 예산은 3,000엔 안팎입니다.',
    ],
    map: '回転寿しトリトン 北8条光星店',
    tel: '0113748666',
  },
  {
    ...
    meta: '토리톤에서 택시 7분 · ¥900 안팎 (도보 20분) · 07:00-17:00',
    desc: [
      '토리톤에서 택시로 7분, 걸으면 20분입니다. 시장은 7시부터 18시까지 열지만 가게 대부분이 17시 전후로 문을 닫습니다. 게와 멜론은 공항 면세보다 여기가 싸고 무거운 건 택배 접수가 됩니다.',
    ],
    map: '二条市場 札幌',
  },
  {
    ...
    desc: [
      '니조시장을 보고 바로 걷습니다. 니조시장에서 소세이강을 따라 오도리공원 동쪽 끝까지 10분이고, 거기 TV타워가 서 있습니다. 공원을 서쪽으로 한두 블록 걷다가 파르코로 내려가면 5분입니다.',
...
const ROUTE_URL =
  ...
  `&origin=${encodeURIComponent('回転寿しトリトン 北8条光星店')}` +
      ...
      <header className={s.cover}>
        ...
        <div className={s.coverBody}>
          ...
          <p className={s.coverLead}>
            오후 1시에 숙소 옆 토리톤 스시로 점심을 시작하고, 니조시장과 오도리공원을 걸은 뒤
            파르코와 미츠코시를 돌고, 다누키코지에서 쉬다가 저녁 7시 30분에 스스키노에서 샤브샤브를
            먹습니다. 돈키호테에서 시세를 본 다음 酒屋 C&amp;C에서 위스키를 사고 택시로 돌아와
            숙소에서 홀덤 캐시게임을 엽니다.
          </p>
      ...
      <main className={s.wrap}>
        <section className={`${s.mapSec} ${s.reveal}`} data-reveal>
          <div className={s.secHead}>
            <h2>동선 지도</h2>
            <small>
              H 숙소 → 1 토리톤 → 2 니조시장 → 3 TV타워 → 4 파르코 → 5 미츠코시 → 6 샤브샤브 → 7
              돈키 → 8 C&amp;C
            </small>
          </div>
          <a
