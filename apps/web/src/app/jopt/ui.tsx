...
const DAYS: DayPlan[] = [
  ...
  {
    // 9/22 자유일 — 11:30 Jay 재조정: 택시로 파르코·미츠코시 → 니조시장 → 샤브샤브(폿케) → 酒屋C&C 위스키 → 귀가.
    // 맥주 박물관은 목요일(Day 4)로. 운영시간·가격은 9/22 공식 사이트·핫페퍼 확인값.
    label: 'Day 2',
    date: '9/22 화',
    km: 3.2,
    min: 60,
    ...
    stops: [
      {
        ...
        stay: '-',
        mode: 'taxi',
        mv: '택시 10분 · ¥1,300 안팎 → 파르코',
        note: '여권 지참 (면세). 흐림 20°/13°, 밤 약한 비 가능. 얇은 겉옷 하나.',
        badge: 'free',
      },
      {
        p: 'parco',
        ...
        stay: '60분',
        mode: 'taxi',
        mv: '택시 하차 · 지하보행공간(치카호) 직결',
        note: '10:00-20:00. 꼼데가르송 · 비비안 웨스트우드 · 유나이티드 애로우즈 · 투모로우랜드 · 디젤 · 요시다 카반(포터) · 프랑프랑. 면세 가능. 8F 레스토랑가 11:00-22:45',
        badge: 'shop',
      },
      {
        p: 'mitsukoshi',
        ...
        mode: 'walk',
        mv: '도보 2분 · 길 건너',
        note: '삿포로 루이비통 1호점 · 1F 티파니·불가리 등 특선 부티크. B1 주류에서 야마자키·히비키 재고 확인 (정가면 1인 1병). 10:00-19:00 (B2-1F는 19:30)',
        badge: 'shop',
      },
      {
        p: 'nijo',
        ...
        mode: 'walk',
        mv: '도보 10분 · 0.7km',
        note: '카이센동 늦은 점심 + 시장 구경. 가게 대부분 17:00-18:00 마감이라 이 시간이 마지막 여유. 게·성게·연어알은 흥정보다 가격표 있는 집으로.',
        badge: 'food',
      },
      {
        p: 'donki',
        ...
        stay: '45분',
        mode: 'walk',
        mv: '도보 8분 · 0.6km · 다누키코지 산책',
        note: '자유 시간. 다누키코지 상점가 따라 걸으며 돈키 위스키 시세만 확인 (정가의 1.5-2배라 사지는 말고 비교용). 편의점 야마자키·하쿠슈 180ml 미니보틀은 정가라 보이면 바로.',
        badge: 'free',
      },
      {
        p: 'pokke',
        ...
        stay: '120분',
        mode: 'walk',
        mv: '도보 3분 · 스스키노역 1번 출구 1분',
        note: '홋카이도 라무(양) 샤브샤브 전문, 눈앞에서 고기를 썰어 줌. 남3조서3 都ビル 3F. 17:00 오픈 (화요일 17:00-24:00). 120분 무한리필+음료 ¥4,480-4,980, 생맥주 포함 ¥6,000, 1인 예산 ¥3,000부터. 8명이라 전화 예약 011-212-1629 (핫페퍼 온라인 예약도 가능).',
        badge: 'food',
      },
      {
        p: 'cc',
        ...
        mode: 'walk',
        mv: '도보 4분 · 0.3km',
        note: '리커즈 카메하타 직영 주류점, 면세 대응. 남5조서4 라일락빌딩 1F, 스스키노역 5번 출구 2분. 월-토 15:00-23:00 (일·공휴일 휴무), 011-518-1351. 정가 기준(2026.4): 야마자키 NV ¥8,250 · 12년 ¥17,600 · 히비키 하모니 ¥8,800. 이보다 비싸면 프리미엄이 붙은 것.',
        badge: 'whisky',
      },
      {
        p: 'house',
        ...
        mode: 'taxi',
        mv: '택시 10분 · ¥1,300 안팎',
        note: '귀가. 내일 11:00 Bullet #47 (레이트 레지 14:55), 숙소→팩토리 홀 도보 15분.',
      },
    ],
  },
  {
    ...
    stops: [
      { p: 'house', t: '10:30', stay: '-', mode: 'walk', mv: '기상 · 준비', note: '' },
      {
        ...
        mode: 'walk',
        mv: '도보 15분 · 1.1km',
        note: 'NLH Bullet #47 필수 · 바우처 ③ (탈락 시 14:55 전 ④ 재엔트리) / 12:00 NLH Sapporo ¥50,000 자비(레지 15:30) · 16:00 Last Party ¥6,000',
        badge: 'main',
      },
      {
        p: 'susukino',
  ...
  {
    // 9/24 목 — 맥주 박물관·비어가든을 이날로 (9/22 Jay). 니조시장은 9/22 에 다녀와서 뺐다.
    label: 'Day 4',
    date: '9/24 목',
    km: 3.6,
    min: 55,
    ...
    stops: [
      ...
      },
      {
        ...
        mode: 'walk',
        mv: '도보 10분 · 0.7km',
        note: '자유 관람 ¥1,000 (한국어 오디오 가이드 포함, 30-40분). 스타홀 3종 비교 세트 ¥1,200 (黒ラベル · 클래식 · 開拓使). 가이드 투어 ¥2,000(55분)는 전날 15시까지 온라인 예약 → 9/23 낮에 예약해 두면 됨. 11:00-18:00',
        badge: 'beer',
      },
      {
        p: 'garden',
        ...
        mode: 'walk',
        mv: '도보 1분 · 옆 건물',
        note: '징기스칸 런치. 뷔페 런치 ¥3,800 (라일락 기준), 벽돌 홀 분위기는 케셀홀. 8명이면 예약센터 전화. 11:30-21:00 (LO 20:40)',
        badge: 'food',
      },
      {
        p: 'ario',
        ...
        mode: 'walk',
        mv: '도보 2분',
        note: '옆 쇼핑몰 (10:00-21:00). 잡화·슈퍼 주류 코너 확인.',
        badge: 'free',
      },
      {
        p: 'odori',
      ...
      },
      {
        ...
        mode: 'subway',
        mv: '지하철 8분',
        note: '마지막 밤. 酒屋C&C(15:00-23:00)에서 위스키 추가 구매도 가능.',
        badge: 'free',
      },
    ],
  },
  {
    ...
    stops: [
      ...
      },
      {
        ...
        mode: 'walk',
        mv: '도보 12분 · 0.9km',
        note: 'JR 쾌속 에어포트 09:30 → 신치토세 10:15 → 12:55 ZE0626 → 16:00 인천 · 국제선 면세 주류 코너에서 야마자키·히비키 마지막 확인',
        badge: 'main',
      },
    ],
  },
