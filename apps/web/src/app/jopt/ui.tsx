...
const DAYS: DayPlan[] = [
  ...
  {
    // 9/22 자유일 — 명품·위스키(삿포로역·오도리) → 숙소 옆 맥주 공장 → 징기스칸.
    // 운영시간·가격은 9/22 오전 공식 사이트 확인값(sapporobeer.jp · daimaru.co.jp · biccamera.com 등).
    label: 'Day 2',
    date: '9/22 화',
    km: 5.5,
    min: 70,
    ...
    stops: [
      {
        ...
        mode: 'walk',
        mv: '출발 · 여권 챙기기',
        note: '면세 카운터도, 위스키 정가 판매점의 1인 1병 확인도 전부 여권으로 합니다. 흐림 20°/13°, 밤 약한 비 가능. 얇은 겉옷 하나.',
        badge: 'free',
      },
      {
        p: 'daimaru',
        ...
        stay: '75분',
        mode: 'walk',
        mv: '도보 15분 · 1.2km (택시 5분)',
        note: '1F 인터내셔널 부티크: 루이비통 · 에르메스 · 샤넬 · 까르띠에 · 구찌 · 프라다 · 보테가 베네타 · 로에베 · 셀린느 · 디올 · 티파니 · 불가리 · 펜디 · 발렌시아가 · 생로랑. 면세 카운터 8F. 에르메스·샤넬은 오픈 직후가 대기가 가장 짧습니다. 나오는 길에 B1 주류에서 야마자키·히비키 재고 확인 (정가면 1인 1병). 10:00-20:00',
        badge: 'shop',
      },
      {
        p: 'bic',
        ...
        mode: 'walk',
        mv: '도보 5분 · 0.4km',
        note: '6F 빅주판. 오늘 위스키를 정가로 살 확률이 가장 높은 곳. 정가(2026.4, 세금 포함): 야마자키 NV ¥8,250 · 12년 ¥17,600 · 히비키 하모니 ¥8,800. 입고분은 선착순 1인 1병, 면세 가능. 없으면 다음 입고 요일을 물어 둘 것. 10:00-20:00',
        badge: 'whisky',
      },
      {
        p: 'stella',
        ...
        mode: 'walk',
        mv: '도보 4분 · 0.3km',
        note: '회전초밥. 대기표 먼저 뽑고 스텔라플레이스 한 바퀴. 줄이 너무 길면 같은 층 스프카레로. 11:00-22:00',
        badge: 'food',
      },
      {
        p: 'mitsukoshi',
        ...
        stay: '50분',
        mode: 'subway',
        mv: '지하철 난보쿠선 삿포로→오도리 1정거장 (도보 12분)',
        note: '삿포로 루이비통 1호점이 여기. 1F 특선 부티크에 티파니·불가리 등 주얼리·시계. 다이마루에서 못 본 라인 채우고 B1 주류도 한 번 더. 10:00-19:00 (B2-1F는 19:30)',
        badge: 'shop',
      },
      {
        p: 'donki',
        ...
        mode: 'walk',
        mv: '도보 5분 · 0.4km',
        note: '시세 확인용. 야마자키·히비키 재고는 거의 항상 있지만 정가의 1.5-2배라 마지막 카드. 오가는 세븐일레븐·로손에서 야마자키·하쿠슈 180ml 미니보틀이 보이면 그건 정가라 바로. 24시간',
        badge: 'whisky',
      },
      {
        p: 'house',
        ...
        mode: 'taxi',
        mv: '택시 10분 · ¥1,000 안팎',
        note: '쇼핑백 내려놓기. 맥주 박물관이 숙소에서 도보 10분이라 들렀다 가는 게 편합니다.',
      },
      {
        p: 'museum',
        t: '16:00',
        ...
        mode: 'walk',
        mv: '도보 10분 · 0.7km',
        note: '자유 관람 ¥1,000 (한국어 오디오 가이드 포함, 30-40분). 마지막 입장 17:30. 스타홀 3종 비교 세트 ¥1,200 (黒ラベル · 클래식 · 開拓使). 가이드 투어 ¥2,000는 전날 15시 온라인 마감이라 오늘은 전화로 빈자리만. 11:00-18:00, 화요일 정상 운영',
        badge: 'beer',
      },
      {
        p: 'garden',
        ...
        mode: 'walk',
        mv: '도보 1분 · 옆 건물',
        note: '징기스칸. 벽돌 홀 분위기는 케셀홀, 무한리필은 라일락·포플러관. 뷔페 디너 ¥5,400 (라일락 기준) + 생맥주. 8명이면 예약센터 전화가 안전. 11:30-21:00 (LO 20:40)',
        badge: 'food',
      },
      {
        p: 'ario',
        ...
        mode: 'walk',
        mv: '도보 2분',
        note: '옆 쇼핑몰(21:00까지). 잡화·슈퍼 주류 마지막 체크 후 도보 10분 귀가. 내일 11:00 Bullet #47, 레이트 레지 14:55, 숙소→팩토리 홀 도보 15분.',
        badge: 'free',
      },
    ],
  },
