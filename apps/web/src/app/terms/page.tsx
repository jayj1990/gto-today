      ...
      <article className="text-body mt-10 space-y-10 leading-[1.75]">
        ...
        <Section index="2" title="용어의 정의">
          <ul className="text-fg-muted list-disc space-y-1 pl-5">
            <li>
              <strong>서비스</strong> — gto.today 웹·모바일 애플리케이션 및 이에 부수되는 모든
              기능을 의미합니다.
            </li>
            <li>
        ...
        <Section index="9" title="책임의 제한">
          <p>
            ...
            게임의 승패를 보장하지 않습니다. 서비스는 이용자가 본 정보를 바탕으로 행한 의사결정에
            대해 법적 책임을 지지 않습니다. 또한 서비스는 관련 법령에서 허용하는 최대 범위에서
            간접적·결과적 손해에 대해 책임을 지지 않습니다.
          </p>
        </Section>

        <Section index="10" title="준거법 및 관할">
          <p>
            본 약관은 대한민국 법령에 따라 해석되며, 서비스와 이용자 간 분쟁에 관한 소송의 관할
        ...
        <Section index="11" title="문의">
          ...
          <p className="text-fg-muted mt-4">본 약관은 {EFFECTIVE_DATE} 부터 적용됩니다.</p>
        </Section>
      </article>
