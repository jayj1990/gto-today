...
export const metadata: Metadata = {
  ...
  description:
    'gto.today 가 어떤 개인정보를 수집하고, 어떻게 쓰며, 언제 파기하는지 안내합니다.',
};
      ...
      <article className="mt-10 space-y-10 text-body leading-[1.75]">
        <Section index="1" title="수집하는 개인정보 항목">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-fg-muted">
            ...
            <li>서비스 이용 중 자동 생성되는 정보: 훈련 기록, 연속 학습 일수, 기기 유형, 접속 IP 로그</li>
          </ul>
        </Section>
        ...
        <Section index="5" title="처리 위탁">
          ...
          <div className="mt-3 overflow-hidden rounded-xl border-hair">
            <table className="w-full font-mono text-[12px]">
              ...
              <tbody className="divide-y divide-[color:var(--color-hair)]">
                ...
                <tr>
                  ...
                  <td className="px-3 py-2">AI 해설 생성 (학습 스팟 메타데이터만 전송, 개인정보 미전송)</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <Section index="7" title="쿠키 및 유사 기술">
          <p>
            ...
            쿠키는 사용하지 않습니다. 브라우저 설정에서 쿠키 저장을 거부할 수 있으나, 이 경우 로그인이
        ...
        <Section index="9" title="고지 의무">
          <p>
            이 방침은 법령 또는 서비스 정책에 따라 변경될 수 있으며, 변경 시 시행일 7일 전부터 서비스
            공지사항 또는 이 페이지에 고지합니다. 중대한 변경의 경우 이메일 등 개별 수단으로 안내할 수
            있습니다.
          </p>
          <p className="mt-3 text-fg-muted">
